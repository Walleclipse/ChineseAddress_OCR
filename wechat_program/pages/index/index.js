  ...
  onLoad: function() {
    ...
    wx.getLocation({
      success: function(data) {
        ...
        console.log(_this.data.markers[0].id);
      }
    });
  },
          ...
          success: function(res) {
            ...
            wx.downloadFile({
              ...
              success: function(res) {
                ...
                wx.request({
                  url: 'https://www.lihao7086.com/download_txt/' + data,
                  success: function(res) {
                    _this.setData({
                      addrline: res.data
                    })
                    wx.navigateTo({
                      url: '../result/result?a=' + _this.data.tempFilePaths_bbox + '&b=' + _this.data.addrline
                    });
                  }
                  // _this.seeMap();
                })
